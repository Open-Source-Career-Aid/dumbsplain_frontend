...
function DumbLevel({
  ...
  useEffect(() => {
    ...
    if (carouseldumbnessLevel >= 1 && carouseldumbnessLevel <= 5) {
      const initialloc =
        dumbnesscarousel.offsetWidth / 2 - dumbnesscarouselelement.offsetWidth * (0.5 + carouseldumbnessLevel - 1);
  ...
  return (
    <div className={dumbnesslevels}>
      ...
      <div className="dumbnesscarousel">
        <div
          className="carouselelementscontainer"
          style={{
          ...
          {[1, 2, 3, 4, 5].map((dumbnesslevel) => {
            return (
              ...
              >
                ...
                <div
                  className={`avatar${dumbnesslevel}`}
                  style={{
                    zIndex: "50",
                  }}
                ></div>

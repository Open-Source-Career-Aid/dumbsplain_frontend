...
function Dumbsplain({ theme, setTheme }) {
  ...
  const handleOverlay = (e) => {
    ...
    switch (e.target.dataset.overlay) {
      case "info":
        infoOverlay ? setInfoOverlay(false) : setInfoOverlay(true);
...
>>>>>>> e1f883a33b5c86af520c6368e94646f4443ea263
        ...
        {width < 900 ? <PlayerProgress dq={userdq} score={score} add={add} sub={sub} /> : null}
      ...
      <div className="dumbsplainbody">
        ...
        >
          {waitfortomorrow ? (
            <>
              <WaitingBox waitingtime={waitingtime} theme={theme} />
            </>
          ) : (
            <>
                  ...
                  {quizme && !mcqloading && !responsesubmitted ? (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <div className="dumbsplainbuttontext takeahint" data-theme={theme}>
                            Take a Hint?
                          </div>
                          <div
                            className="decrement"

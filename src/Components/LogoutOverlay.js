      ...
      >
        ...
        <div className="infocontainer">
          <div className="headercontainer">
            <h1 className="heading-logout">Are you sure you want to logout?</h1>
        ...
        <div>
          ...
          <button className="tw-rounded-xl tw-bg-white hover:tw-bg-orange_200 hover:tw-text-white hover:tw-border-orange_200 tw-border tw-border-blue_400 tw-w-full tw-lg:w-auto">
            Go to profile
          </button>
        </div>
      </div>
